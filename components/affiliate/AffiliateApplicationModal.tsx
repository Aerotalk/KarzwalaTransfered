...
// import { apiClient } from "@/lib/api"; // Removed for mock
    ...
    const handleStep1Submit = async (data: AffiliateStep1Data) => {
        ...
        try {
            if (!otpSent) {
                ...
                // Verify OTP
                await new Promise(resolve => setTimeout(resolve, 1000));
                if (data.otp === "123456" || data.phoneNumber === "9000000001") {
                    setStep(2);
                ...
                <div className="bg-gradient-to-br from-orange-50 to-white p-8">
                    ...
                    {isSuccess ? (
                        <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
                            ...
                            <Button onClick={onClose} className="mt-4 bg-[#F46300] hover:bg-orange-600">
                                Close
                            </Button>
                        </div>
                    ) : (
                        <>
                            {step === 1 && (
                                <form onSubmit={step1Form.handleSubmit(handleStep1Submit)} className="space-y-5">
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="h-12 border-gray-200 focus:ring-orange-500"
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex">
                                                ...
                                                <Input
                                                    ...
                                                    className="rounded-l-none h-12 border-gray-200 focus:ring-orange-500"
                                                    disabled={otpSent || isLoading}
                                                />
                                            </div>
                                            ...
                                            <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
                                                ...
                                                <div className="flex justify-between items-center text-xs">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`font-semibold ${resendTimer > 0 ? "text-gray-400" : "text-[#F46300] hover:underline"}`}
                                    ...
                                    <Button
                                        type="submit"
                                        className="w-full h-12 bg-[#F46300] hover:bg-orange-600 text-white font-bold rounded-xl transition-all shadow-md active:scale-95"
                                        disabled={isLoading}
                                    >
                                        {isLoading ? (
                            ...
                            {step === 2 && (
                                <form onSubmit={step2Form.handleSubmit(handleStep2Submit)} className="space-y-6">
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="h-12 border-gray-200 focus:ring-orange-500 uppercase"
                                                disabled={isLoading}
                                            />
                                        ...
                                        <div className="flex items-start space-x-3 pt-2">
                                            <Checkbox
                                                ...
                                                className="mt-1 border-gray-300 data-[state=checked]:bg-[#F46300] data-[state=checked]:border-[#F46300]"
                                            />
                                            <Label
                                                htmlFor="acceptance"
                                    ...
                                    <div className="flex">
                                        <Button
                                            type="submit"
                                            className="h-12 w-full bg-[#F46300] hover:bg-orange-600 text-white font-bold rounded-xl transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
