    ...
    <section className="w-full max-w-7xl mx-auto py-4 p-6 md:p-12 lg:p-20">
      <div className="flex flex-col justify-center items-center-safe space-y-6 w-full">
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-8 justify-between items-center gap-4 w-full">
          ...
          {/* Right side results */}
          <div className="bg-orange-100 text-orange-600 w-full lg:w-1/2 px-6 py-8 rounded-lg flex flex-col space-y-4">
            ...
            <Button
              ...
              className="w-full mt-2 bg-orange-600 text-white hover:bg-orange-400 font-medium py-3 cursor-pointer"
              type="button"
            >
              Apply Loan
            </Button>
