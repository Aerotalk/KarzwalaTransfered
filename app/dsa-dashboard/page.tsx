...
function DSADashboardContent() {
    ...
    // Fetch dashboard mock data on mount
    useEffect(() => {
        setTimeout(() => {
            setDashboardData({
                stats: {
            ...
            setReferralLink("https://karzwala.in/agent?ref=AG_DSA_999");
            ...
            setEarningsData([
                ...
                { id: "APP003", name: "Vikram Malhotra", amount: "₹2,50,000", status: "Rejected", rawStatus: "REJECTED", date: "15-10-2025", earnings: "₹0" },
            ]);

            setProfileData({
                name: "Karzwala DSA Partner",
                email: "dsa.partner@karzwala.in",
                phone: "+91 99887 76655",
                firmName: "Best Loans Associates",
        ...
        <div className="space-y-12">
            <div className="relative">
                <button
                    ...
                    className="flex items-center justify-between gap-4 bg-white hover:border-orange-200 transition-all min-w-[200px] px-5 py-2.5 rounded-2xl text-[14px] font-bold text-gray-900 border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
                >
                            ...
                            <div className="space-y-8">
                                ...
                                {!tempDate.isLifetime ? (
                                            ...
                                            <div className="flex gap-2">
                                                {years.map(year => (
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2.5 rounded-xl text-[12px] font-bold transition-all border ${tempDate.year === year ? 'bg-orange-50 border-orange-200 text-orange-600' : 'bg-white border-gray-100 text-gray-400 hover:bg-gray-50'}`}
                                                    >
                                                        {year}
                                                    </button>
                                                ))}
                                            ...
                                            <div className="grid grid-cols-3 gap-2.5 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                                                {months.map(month => (
                                                    <button
                                                        ...
                                                        className={`py-2 rounded-xl text-[12px] font-bold transition-all border ${tempDate.month === month ? 'bg-orange-50 border-orange-200 text-orange-600' : 'bg-white border-gray-100 text-gray-400 hover:bg-gray-50'}`}
                                                    >
                                                        {month.slice(0, 3)}
                                                    </button>
                                                ))}
                                    ...
                                    <div className="py-6 text-center space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                        <div className="w-16 h-16 bg-orange-50 rounded-full flex items-center justify-center mx-auto shadow-inner">
                                ...
                                <div className="pt-2 border-t border-gray-50">
                                    <button
                                        ...
                                        className="w-full bg-[#F46300] text-white py-4 rounded-2xl font-bold text-[15px] shadow-xl shadow-orange-100 hover:bg-orange-600 transition-all active:scale-[0.98]"
                                    >
                                        Apply Filter
                                    </button>
                                </div>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {earningsData.length === 0 ? (
                                ...
                                earningsData.map((item, index) => (
                                    <tr key={index} className="group hover:bg-orange-50/20 transition-all">
    ...
    const renderTrackLoan = () => (
        <div className="max-w-5xl space-y-12">
            <h2 className="text-[28px] font-bold text-[#F46300]">Track Loan</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                <div className="space-y-2.5">
                    ...
                    <input
                        ...
                        className="w-full bg-[#F9FAFB] border border-gray-50 rounded-2xl px-6 py-4 text-gray-700 font-medium outline-none focus:bg-white focus:ring-2 focus:ring-orange-50 transition-all"
                    />
                </div>
                <div className="space-y-2.5">
                    <label className="text-[15px] font-medium text-[#111827] block px-1">
    ...
    const renderSupport = () => (
        <div className="space-y-12">
            <h2 className="text-[28px] font-bold text-[#F46300]">Connect us</h2>
            ...
            <div className="flex flex-col md:flex-row items-start gap-12 md:gap-24">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <p className="text-[17px] font-bold text-gray-900">Email: support@karzwala.in</p>
                    </div>
                </div>
            </div>
                            ...
                            {sidebarItems.map((item) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 px-6 py-4 rounded-2xl transition-all font-medium ${activeTab === item.name
                                        ? "bg-[#F46300] text-white shadow-lg shadow-orange-200"
