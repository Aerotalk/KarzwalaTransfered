...
function DashboardContent() {
    ...
    const renderDashboardContent = () => (
        <div className="space-y-16">
            ...
            <section className="max-w-5xl">
                <h2 className="text-[28px] font-bold text-[#F46300] mb-8">Employment Details</h2>
            ...
            <section className="max-w-5xl">
                <h2 className="text-[28px] font-bold text-[#F46300] mb-8">Address Details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mb-8">
    ...
    const renderTrackLoanContent = () => (
        <div className="max-w-5xl space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                <div className="space-y-2.5">
                    ...
                    <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl px-6 py-4 text-gray-700 font-medium outline-none focus:ring-1 focus:ring-orange-100 transition-all"
                    />
                </div>
                <div className="space-y-2.5">
                    <label className="text-[15px] font-bold text-gray-900 block px-1">
            ...
            <div>
                <button className="bg-[#F46300] text-white px-10 py-4 rounded-xl font-bold hover:bg-orange-600 transition-all shadow-lg shadow-orange-100">
                    Track now
                </button>
            </div>
        </div>
        ...
        <div className="max-w-5xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start py-4">
                ...
                <div className="flex flex-col items-center space-y-4">
                    <button className="bg-[#F46300] text-white px-6 py-3.5 rounded-xl font-bold hover:bg-orange-600 transition-all shadow-lg shadow-orange-100 w-full text-center text-sm">
    ...
    const renderLoanHistoryContent = () => (
        <div className="max-w-5xl space-y-10">
            <div className="flex items-center justify-between">
                <h2 className="text-[28px] font-extrabold text-[#111827] tracking-tight text-[#F46300]">Loan History</h2>
            </div>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {loanHistory.map((loan) => (
                                <tr key={loan.id} className="group hover:bg-orange-50/20 transition-all">
                                    ...
                                    <td className="px-8 py-6 text-right">
                                        <button className="inline-flex items-center gap-2 text-orange-500 font-bold text-sm bg-orange-50 hover:bg-orange-500 hover:text-white px-5 py-2.5 rounded-xl transition-all shadow-sm active:scale-95 group/btn">
                                            <span>Reapply</span>
