...
interface StateFeaturesProps {
    state: string;
}

const StateFeatures: React.FC<StateFeaturesProps> = ({ state }) => {
    ...
    // List of states for the "Other States" section
    const allStates = [
        { name: "Gujarat", link: "/states/payday-loan-in-gujarat" },
        { name: "Bihar", link: "/states/payday-loan-in-bihar" },
        { name: "Orissa", link: "/states/payday-loan-in-orissa" },
        { name: "Jharkhand", link: "/states/payday-loan-in-jharkhand" },
        { name: "Assam", link: "/states/payday-loan-in-assam" },
        { name: "Punjab", link: "/states/payday-loan-in-punjab" },
        { name: "Chattisgarh", link: "/states/payday-loan-in-chattisgarh" },
        { name: "Madhya Pradesh", link: "/states/payday-loan-in-madhya-pradesh" },
        { name: "West Bengal", link: "/states/payday-loan-in-west-bengal" },
    ];

    // Filter out current state (case insensitive check)
    const otherStates = allStates.filter(s => s.name.toLowerCase() !== state.toLowerCase());
                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Interest Rate On Personal Loan <span className="text-orange-500">in {state}</span>
                            </h2>

                            <div className="text-gray-600 space-y-4 text-lg leading-relaxed">
                                <p>
                                    At Karzwala, personal loan interest rates in {state} start from 8.5% p.a. Your rate depends on your credit score, monthly income, and existing loans. Better credit scores get lower rates. We follow simple and transparent pricing - good credit history gets you our best rates.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <span className="text-orange-500"> Personal Loan in {state} from Karzwala?</span>
                            </h2>
                            ...
                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p><strong className="text-gray-900">Salary:</strong> Stable monthly income for salaried individuals</p>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                in <span className="text-orange-500">Other States</span>
                            </h2>

                            <p className="text-gray-600 text-lg leading-relaxed mb-8">
                                Karzwala offers loans across major states in India. Explore our services in other locations.
                            </p>
                                ...
                                {otherStates.map((item, index) => (
                                    <Card key={index} className="bg-orange-50/50 border-orange-100 overflow-hidden hover:shadow-md transition-shadow h-full pb-0 gap-0">
                                        <CardContent className="p-6 text-center flex-1 flex flex-col justify-center">
                                            <p className="text-gray-500 text-sm mb-2">Insta loan in</p>
                    ...
                    <div className="lg:w-1/3">
                        <div className="sticky top-24 bg-orange-50 rounded-2xl p-8 border border-orange-100">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">
                                ...
                                <span className="text-orange-500"> Personal Loan in {state}?</span>
                            </h3>
