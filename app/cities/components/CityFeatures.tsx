...
const CityFeatures: React.FC<CityFeaturesProps> = ({ city }) => {
    ...
    // List of cities for the "Other Cities" section
    const allCities = [
        { name: "Mumbai", link: "/cities/payday-loan-in-mumbai" },
        { name: "Delhi", link: "/cities/payday-loan-in-delhi" },
        { name: "Bengaluru", link: "/cities/payday-loan-in-bengaluru" },
        { name: "Hyderabad", link: "/cities/payday-loan-in-hyderabad" },
        { name: "Pune", link: "/cities/payday-loan-in-pune" },
        { name: "Kolkata", link: "/cities/payday-loan-in-kolkata" },
        { name: "Chennai", link: "/cities/payday-loan-in-chennai" },
    ];

    // Filter out current city (case insensitive check)
    const otherCities = allCities.filter(c => c.name.toLowerCase() !== city.toLowerCase());
                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Interest Rate On Personal Loan <span className="text-orange-500">in {city}</span>
                            </h2>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <span className="text-orange-500"> Personal Loan in {city} from Karzwala?</span>
                            </h2>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                in <span className="text-orange-500">Other Cities</span>
                            </h2>

                            <p className="text-gray-600 text-lg leading-relaxed mb-8">
                                Karzwala offers loans across major cities in India. Explore our services in other locations.
                            </p>
                    ...
                    <div className="lg:w-1/3">
                        <div className="sticky top-24 bg-orange-50 rounded-2xl p-8 border border-orange-100">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">
                                ...
                                <span className="text-orange-500"> Personal Loan in {city}?</span>
                            </h3>
