                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Personal Loan Interest Rates <span className="text-orange-500">for Self-employed</span>

                            </h2>

                            <div className="text-gray-600 space-y-4 text-lg leading-relaxed">
                                <p>
                                    We decide your interest rate based on your credit score and business income. The better your credit profile and business stability, the lower rate you get. We believe in fair and transparent pricing - self-employed individuals with good credit history and stable business income get the best rates
                                </p>

                                <p className="font-semibold text-gray-900 mt-6">Your rate depends on:</p>
                                <ul className="list-disc pl-5 space-y-2">
                                    <li>Your credit score (650+ gets best rates)</li>
                                    <li>Your business income and profitability</li>
                                    <li>Your existing debts and liabilities</li>
                                    <li>Your business continuity and stability</li>
                                    <li>Quality of financial documents (ITR, P&L, Balance Sheet)</li>
                                </ul>
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p><strong className="text-gray-900">Business Income:</strong> At least ₹2 lakh per annum (net profit</p>
                                    <p><strong className="text-gray-900">Age Limit:</strong> Usually 21-60 years for salaried employees</p>
                                    <p><strong className="text-gray-900"> Business Type:</strong> Proprietors, Partners, Freelancers, Consultants, Doctors, CAs, Architects, and other professionals</p>
                                    <p><strong className="text-gray-900"> ITR Filing:</strong> Last 2 years ITR filed and acknowledged</p>
                                    <p><strong className="text-gray-900"> Business Proof:</strong> GST registration, Shop Act License, or Business registration documents</p>
                                </div>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                Required for <span className="text-orange-500">Self-Employed</span>
                                <br />
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                <span className="text-orange-500">Personal Loan as Self-Employed</span>
                            </h2>

                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                <p>
                                    Self-employed individuals planning to get a personal loan can improve their
                                    chances of approval by following these tips:
                                </p>
                                ...
                                <ul className="list-disc pl-5 space-y-4">
                                    ...
                                    <li><strong className="text-gray-900">File ITR regularly for at least 2-3 years</strong> - Shows income consistency and tax compliance</li>
                                    <li><strong className="text-gray-900">Keep business financials updated</strong> - Maintain proper P&L statements and Balance Sheets</li>
                                    <li><strong className="text-gray-900">Show business stability of 3+ years</strong> - Longer business history means better chances</li>
                                    <li><strong className="text-gray-900">Avoid making multiple loan applications</strong> - Apply only where you have good chances of approval</li>
                                    <li><strong className="text-gray-900">Maintain healthy business bank statements</strong> - Regular income credits show business activity</li>
                                    <li><strong className="text-gray-900">Have proper business documentation</strong> - GST, Shop Act, Trade License strengthen your application</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
export default SelfLoanFeatures;                      