                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Interest Rate On Personal Loan <span className="text-orange-500">for ₹40,000 Salary</span>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <span className="text-orange-500"> Personal Loan at ₹40,000 Salary from Karzwala?</span>
                    ...
                    <div className="lg:w-1/3">
                        <div className="sticky top-24 bg-orange-50 rounded-2xl p-8 border border-orange-100">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">
                                ...
                                <span className="text-orange-500"> Personal Loan with ₹40,000 Salary?</span>
                            </h3>
