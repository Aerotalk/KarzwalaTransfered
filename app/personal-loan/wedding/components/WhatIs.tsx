            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-16">
                <div className="text-start mb-16">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                        What is a personal loan for <span className="text-[#FF6B2C]">Weddings?</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <p className="text-gray-600 text-[16px]">A personal loan for wedding is offered by NBFCs like Karzwala to individuals planning their marriage without any collateral or guarantor to meet their wedding expenses. Whether you need funds for venue booking, catering, wedding shopping, jewelry, photography, honeymoon, or any other marriage-related expense, this loan helps you celebrate your special day without financial stress. The loan is repaid by borrowers in equated monthly installments over a pre-decided tenure, usually ranging from 1 to 5 years. We decide the creditworthiness of applicants by assessing their credit profile (CIBIL Score), monthly income, employment stability, and repayment capacity.
