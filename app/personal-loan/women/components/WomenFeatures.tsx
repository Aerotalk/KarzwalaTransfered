                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Personal Loan Interest Rates <span className="text-orange-500">for Women</span>
                            ...
                            <div className="text-gray-600 space-y-4 text-lg leading-relaxed">
                                ...
                                <ul className="list-disc pl-5 space-y-2">
                                    ...
                                    <li>Quality of employment documents</li>
                                </ul>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <span className="text-orange-500"> Women to Get a Personal Loan from Karzwala?</span>
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-4">
                                        <h3 className="text-gray-900 font-bold text-xl">For Salaried Women:</h3>
                                        <ul className="list-disc pl-5 space-y-2">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-gray-900 font-bold text-xl">For Self-Employed Women:</h3>
                                        <ul className="list-disc pl-5 space-y-2">
                                            <li><strong className="text-gray-900">ID Proof:</strong> Aadhaar, PAN, Passport, Voter ID, or Driving License</li>
                                            <li><strong className="text-gray-900">Address Proof:</strong> Aadhaar, Passport, Voter ID, or recent utility bills</li>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                <span className="text-orange-500">Personal Loan as A Woman</span>
                            </h2>

                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                <p>
                                    Women planning to get a personal loan can improve their chances of approval by following these tips:
                                </p>
