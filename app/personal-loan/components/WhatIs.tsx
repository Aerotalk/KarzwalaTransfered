            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-16">
                <div className="text-start mb-16">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                        What is a <span className="text-[#FF6B2C]">personal loan?</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <p className="text-gray-600 text-[16px]">A personal loan is  offered by banks and NBFCs to their eligible customers without any collateral and guarantor  to meet their urgent financial requirements. This loan is repaid by borrowers in equated monthly installments (EMIs) over a pre-decided tenure by the bank/NBFCs, usually ranging from 1 to 5 years. Lenders decide the creditworthiness of the applicant by assessing their credit profile(CIBIL Score) , Monthly income, repayment capacity, etc.
                        </p>
                    </div>
