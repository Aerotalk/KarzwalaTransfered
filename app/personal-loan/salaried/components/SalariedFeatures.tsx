                    ...
                    <div className="lg:w-2/3 space-y-12">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                Personal Loan Interest Rates <span className="text-orange-500">for Salaried Employees</span>

                            </h2>

                            <div className="text-gray-600 space-y-4 text-lg leading-relaxed">
                                <p>
                                    We decide your interest rate based on your credit score and monthly salary. The better your credit profile and employment stability, the lower rate you get. We believe in fair and transparent pricing - salaried employees with good credit history and stable income get the best rates.
                                </p>

                                <p className="font-semibold text-gray-900 mt-6">Your rate depends on:</p>
                                <ul className="list-disc pl-5 space-y-2">
                                    <li>Your credit score (650+ gets best rates)</li>
                                    <li>Your monthly salary and take-home income</li>
                                    <li>Your existing debts and liabilities</li>
                                    <li>Your employment stability and employer profile</li>
                                    <li>Quality of employment documents (salary slips, Form 16)</li>
                                </ul>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <span className="text-orange-500"> Self-Employed to Get a Personal Loan from Karzwala?</span>
                            ...
                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p><strong className="text-gray-900">Age Limit:</strong> Usually 21-60 years for salaried employees</p>
                                    <p><strong className="text-gray-900">Employment Type:</strong> Permanent or confirmed employees (probation completed)</p>
                                    <p><strong className="text-gray-900">Work Experience:</strong> At least 1-2 years of total work experience</p>
                                    <p><strong className="text-gray-900">Current Job Stability:</strong> Minimum 6 months with current employer</p>
                                    <p><strong className="text-gray-900">Employer Profile:</strong> Government employees, PSU staff, MNC employees, and employees of reputed companies are preferred</p>
                                    <p><strong className="text-gray-900">Salary Account:</strong> Active salary account with regular salary credits</p>
                                </div>
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                Required for <span className="text-orange-500">Salaried Employees</span>
                                <br />
                            ...
                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                <p>
                                    We keep documentation simple for salaried applicants. Here's what you need to have ready:
                                </p>
                                <div className="space-y-4">
                                    <p>
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc pl-5 space-y-1">
                                            ...
                                            <li>Employment letter or appointment letter</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p className="font-bold text-gray-900 mb-2">Employment Proof:</p>
                                        <ul className="list-disc pl-5 space-y-1">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                                ...
                                <br />
                                <span className="text-orange-500">Personal Loan as Salaried Employee</span>
                            </h2>

                            <div className="text-gray-600 space-y-6 text-lg leading-relaxed">
                                <p>
                                    Salaried employees planning to get a personal loan can improve their chances of approval by following these tips:
                                </p>

                                <ul className="list-disc pl-5 space-y-4">
                                    <li><strong className="text-gray-900">Maintain your credit/CIBIL score above 750</strong> - This is the most important factor for quick approval</li>
                                    <li><strong className="text-gray-900">Show stable employment history</strong> - Stay in your current job for at least 6 months before applying</li>
                                    <li><strong className="text-gray-900">Keep salary account active</strong> - Regular salary credits for at least 6 months strengthen your profile</li>
                                    <li><strong className="text-gray-900">Avoid too many existing loans</strong> - Keep your debt-to-income ratio below 50%</li>
                                    <li><strong className="text-gray-900">Apply for realistic loan amounts</strong> - Don't apply for amounts that exceed 15-20 times your monthly salary</li>
                                    <li><strong className="text-gray-900">Have all documents ready</strong> - Clear salary slips, bank statements, and ID proofs speed up approval</li>
                                    <li><strong className="text-gray-900">Avoid multiple loan applications</strong> - Apply only where you have good chances of approval</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/3">
                        <div className="sticky top-24 bg-orange-50 rounded-2xl p-8 border border-orange-100">
                            <h3 className="text-2xl font-bold text-gray-900 mb-4">
                                How Can Salaried Employees Apply
...
export default SalariedFeatures;