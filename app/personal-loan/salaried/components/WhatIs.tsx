            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-16">
                <div className="text-start mb-16">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">
                        What is a personal loan for the<span className="text-[#FF6B2C]"> Salaried Employees?</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <p className="text-gray-600 text-[16px]">A personal loan for salaried employees is offered by NBFCs like Karzwala to working professionals without any collateral or guarantor to meet their urgent financial requirements. Whether you need funds for medical emergencies, wedding expenses, home renovation, debt consolidation, education fees, or travel, this loan helps you manage your financial needs. The loan is repaid by borrowers in equated monthly installments over a pre-decided tenure, usually ranging from 1 to 5 years. We decide the creditworthiness of salaried applicants by assessing their credit profile (CIBIL Score), monthly salary, employment stability, and repayment capacity.
